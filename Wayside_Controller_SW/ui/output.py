...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.program_select_spinbox = QSpinBox(self.tab_1)
        self.program_select_spinbox.setObjectName(u"program_select_spinbox")
        self.program_select_spinbox.setWrapping(True)
        self.program_select_spinbox.setFrame(False)
        self.program_select_spinbox.setKeyboardTracking(False)
        self.program_select_spinbox.setMinimum(1)
        self.program_select_spinbox.setMaximum(3)

        self.horizontalLayout_2.addWidget(self.program_select_spinbox, 0, Qt.AlignRight)
        ...
        self.yard_return_box = QCheckBox(self.tab_1)
        self.yard_return_box.setObjectName(u"yard_return_box")

        self.verticalLayout_4.addWidget(self.yard_return_box, 0, Qt.AlignHCenter)
        ...
        self.tb_block_label.setMaximumSize(QSize(16777215, 40))
        ...
        self.tb_block_table.setMinimumSize(QSize(900, 0))
        ...
        self.tb_block_table.horizontalHeader().setStretchLastSection(True)
        ...
        self.tb_occ.setGeometry(QRect(10, 30, 111, 20))
        self.tb_dis = QCheckBox(self.groupBox)
        self.tb_dis.setObjectName(u"tb_dis")
        self.tb_dis.setGeometry(QRect(10, 50, 221, 20))

        self.gridLayout_6.addWidget(self.groupBox, 1, 0, 2, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt;\">Track Logic Programs</span></p></body></html>", None))
        self.PLC_label.setText(QCoreApplication.translate("MainWindow", u"sample_file.eds", None))
        self.PLC_download.setText(QCoreApplication.translate("MainWindow", u"View file", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Selected Program:    ", None))
        ...
        self.yard_return_box.setText(QCoreApplication.translate("MainWindow", u"Yard Return Mode", None))
        ...
        ___qtablewidgetitem27.setText(QCoreApplication.translate("MainWindow", u"Authority", None));
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Device Inputs", None))
